...
def generate_image(data, filename):
    ...
    name_text_widths = [font.getbbox(row[1])[2] for row in data["rows"]]
    ...
    def draw_cell(x, y, text, width, is_header=False, align="center"):
        rect_x1, rect_y1 = x, y
    ...
    for row in data["rows"]:
        ...
        for col, value in enumerate(row):
            ...
            draw_cell(x_offset, y_offset, str(value), cell_widths[col], align=align)
            x_offset += cell_widths[col]
        y_offset += cell_height
